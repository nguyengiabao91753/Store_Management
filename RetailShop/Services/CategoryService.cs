...
namespace RetailShop.Services
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<ResultService<bool>> SoftDeleteCategoryAsync(int id)
        {
            ...
            try
            {
                ...
                if (!category.Active)
                {
                    rs.IsSuccess = true;
                    rs.Data = true;
                    rs.Message = "Category is already inactive.";
                    return rs;
                }
                ...
                rs.IsSuccess = true;
                rs.Data = true;
                rs.Message = "Category deactivated (soft delete) successfully.";
            }
            catch (Exception ex)
            {
                rs.IsSuccess = false;
                rs.Message = $"Error deleting category: {ex.Message}";
            }
